                    ...
                    <div class="container-fluid p-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                            <ul class="navbar-nav mb-2 mb-lg-0 d-flex justify-content-end">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="#section">Home</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="row container">
                <div class="col-12">
                    ...
                    <div class="face" id="face" >
                        <img id="face-img" class="face-img" src="img/adham-dannaway-designer-coder.jpg" alt="Adham Dannaway UI designer" style="display: none; opacity: 1;">
                        <div id="designer-img" class="designer-img" style="display: block;"></div>
                        <div id="coder-img" class="coder-img" style="display: block;"></div>
